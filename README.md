...
9. Navigate to your VPN server's (slave) config file in /etc/wireguard/wg0.conf and move the recently copied private key to the correct row
...
11. Navigate to `/etc/wireguard/wg0.conf` on your VPN peer (master) and move the recently copied private key to the correct row
